...
const table_model_1 = require("../../models/table/table.model");
let TableDocumentService = class TableDocumentService {
    /**
     * Class constructor
     *
    ...
    create(table) {
        return fromPromise_1.fromPromise(this._document.findOne({
            ...
            throw_1._throw(new Error(`Room with name '${table.name}' already exists`)) :
            fromPromise_1.fromPromise(this._document.create(table))), operators_1.map((doc) => doc.toJSON()));
    }
    /**
     ...
     * @return {Observable<Room>}
     */
    findByIdAndUpdate(id, table) {
        return fromPromise_1.fromPromise(this._document.findByIdAndUpdate(id, table, { new: true }))
            .pipe(operators_1.flatMap((doc) => !!doc ?
            of_1.of(doc.toJSON()) :
            of_1.of(undefined)));
    }
...
TableDocumentService = __decorate([
    core_1.Injectable(),
    __metadata("design:paramtypes", [mongo_1.MongoClientService])
], TableDocumentService);
exports.TableDocumentService = TableDocumentService;
//# sourceMappingURL=table-document.service.js.map